...
PrintMST(Vertices * graph)
{
  ...
  ((void) sizeof ((graph != ((void *) 0)) ? 1 : 0), __extension__ ({ if (graph != ((void *) 0)) ; else __assert_fail ("graph != NULL_VERTEX", "/home/matt/analyze-conversion/src/Ptrdist/ft/tmp-em-manual/ft.c", 183, __extension__ __PRETTY_FUNCTION__); }));
