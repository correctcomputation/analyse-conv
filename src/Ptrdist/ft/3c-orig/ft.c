...
PrintMST(_Ptr<Vertices> graph)
{
  ...
  ((void) sizeof ((graph != ((void *) 0)) ? 1 : 0), __extension__ ({ if (graph != ((void *) 0)) ; else __assert_fail ("graph != NULL_VERTEX", "/home/matt/analyze-conversion-1.wt/src/Ptrdist/ft/orig-em-tmp/ft.c", 181, __extension__ __PRETTY_FUNCTION__); }));
