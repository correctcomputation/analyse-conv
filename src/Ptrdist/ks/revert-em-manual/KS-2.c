...
FindMaxGpAndSwap(void)
{
 ...
 for (mrB = groupB.head, mrPrevB = ((void*)0);
  ...
  maxB = mrB; maxPrevB = mrPrevB;
    ...
    ((void) sizeof ((maxA != ((void*)0)) ? 1 : 0), __extension__ ({ if (maxA != ((void*)0)) ; else __assert_fail ("maxA != NULL", "/home/matt/analyze-conversion/src/Ptrdist/ks/tmp-em-manual/KS-2.c", 145, __extension__ __PRETTY_FUNCTION__); }));
     { SwapNode(maxPrevA, maxA, &(groupA), &(swapToB)); }
    ((void) sizeof ((maxB != ((void*)0)) ? 1 : 0), __extension__ ({ if (maxB != ((void*)0)) ; else __assert_fail ("maxB != NULL", "/home/matt/analyze-conversion/src/Ptrdist/ks/tmp-em-manual/KS-2.c", 147, __extension__ __PRETTY_FUNCTION__); }));
     { SwapNode(maxPrevB, maxB, &(groupB), &(swapToA)); }



    ((void) sizeof ((moduleToGroup[(*maxA).module] == GroupA) ? 1 : 0), __extension__ ({ if (moduleToGroup[(*maxA).module] == GroupA) ; else __assert_fail ("moduleToGroup[(*maxA).module] == GroupA", "/home/matt/analyze-conversion/src/Ptrdist/ks/tmp-em-manual/KS-2.c", 152, __extension__ __PRETTY_FUNCTION__); }));
    moduleToGroup[(*maxA).module] = SwappedToB;

    ((void) sizeof ((moduleToGroup[(*maxB).module] == GroupB) ? 1 : 0), __extension__ ({ if (moduleToGroup[(*maxB).module] == GroupB) ; else __assert_fail ("moduleToGroup[(*maxB).module] == GroupB", "/home/matt/analyze-conversion/src/Ptrdist/ks/tmp-em-manual/KS-2.c", 155, __extension__ __PRETTY_FUNCTION__); }));
...
SwapSubsetAndReset(unsigned long iMax)
{
  ...
  i++);
    ...
    ((void) sizeof ((mrPrevA != ((void*)0) && mrPrevB != ((void*)0)) ? 1 : 0), __extension__ ({ if (mrPrevA != ((void*)0) && mrPrevB != ((void*)0)) ; else __assert_fail ("mrPrevA != NULL && mrPrevB != NULL", "/home/matt/analyze-conversion/src/Ptrdist/ks/tmp-em-manual/KS-2.c", 204, __extension__ __PRETTY_FUNCTION__); }));
...
PrintResults(int verbose)
{
 ...
 ((void) sizeof ((moduleToGroup[(*mr).module] == GroupA) ? 1 : 0), __extension__ ({ if (moduleToGroup[(*mr).module] == GroupA) ; else __assert_fail ("moduleToGroup[(*mr).module] == GroupA", "/home/matt/analyze-conversion/src/Ptrdist/ks/tmp-em-manual/KS-2.c", 276, __extension__ __PRETTY_FUNCTION__); }));
 ...
 for (nn = modules[(*mr).module]; nn != ((void*)0); nn = (*nn).next) {
  ...
  netSz++;
     ((void) sizeof ((netSz >= 2) ? 1 : 0), __extension__ ({ if (netSz >= 2) ; else __assert_fail ("netSz >= 2", "/home/matt/analyze-conversion/src/Ptrdist/ks/tmp-em-manual/KS-2.c", 284, __extension__ __PRETTY_FUNCTION__); }));
 ...
 for (mn = nets[i]; mn != ((void*)0); mn = (*mn).next)
     netSz++;
 ((void) sizeof ((netSz >= 2) ? 1 : 0), __extension__ ({ if (netSz >= 2) ; else __assert_fail ("netSz >= 2", "/home/matt/analyze-conversion/src/Ptrdist/ks/tmp-em-manual/KS-2.c", 309, __extension__ __PRETTY_FUNCTION__); }));
 ...
 for (grp=moduleToGroup[(*(nets[i])).module],mn = (*(nets[i])).next;
  ...
  break;
    ...
    for (i=2; i<=maxStat; i++)
  { (fprintf)(stdout, "sz:%5lu     total:%5lu     edgesCut:%5lu     netsCuts:%5lu\n", i, netStats[i].total, netStats[i].edgesCut, netStats[i].netsCut); };
...
main(int argc, char * * argv )
{
 ...
 ReadNetList(argv[1]);
    ...
    ((void) sizeof (((numModules % 2) == 0) ? 1 : 0), __extension__ ({ if ((numModules % 2) == 0) ; else __assert_fail ("(numModules % 2) == 0", "/home/matt/analyze-conversion/src/Ptrdist/ks/tmp-em-manual/KS-2.c", 357, __extension__ __PRETTY_FUNCTION__); }));
 ...
 ((void) sizeof ((groupA.head == ((void*)0) && groupA.tail == ((void*)0)) ? 1 : 0), __extension__ ({ if (groupA.head == ((void*)0) && groupA.tail == ((void*)0)) ; else __assert_fail ("groupA.head == NULL && groupA.tail == NULL", "/home/matt/analyze-conversion/src/Ptrdist/ks/tmp-em-manual/KS-2.c", 386, __extension__ __PRETTY_FUNCTION__); }));
 ((void) sizeof ((groupB.head == ((void*)0) && groupB.tail == ((void*)0)) ? 1 : 0), __extension__ ({ if (groupB.head == ((void*)0) && groupB.tail == ((void*)0)) ; else __assert_fail ("groupB.head == NULL && groupB.tail == NULL", "/home/matt/analyze-conversion/src/Ptrdist/ks/tmp-em-manual/KS-2.c", 387, __extension__ __PRETTY_FUNCTION__); }));
