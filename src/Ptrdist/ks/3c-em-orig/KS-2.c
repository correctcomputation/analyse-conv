...
FindMaxGpAndSwap()
{
 ...
 for (mrB = groupB.head, mrPrevB = ((void*)0);
  ...
  maxB = mrB; maxPrevB = mrPrevB;
    ...
    ((void) sizeof ((maxA != ((void*)0)) ? 1 : 0), __extension__ ({ if (maxA != ((void*)0)) ; else __assert_fail ("maxA != NULL", "/home/matt/analyze-conversion/src/Ptrdist/ks/tmp-em-orig/KS-2.c", 143, __extension__ __PRETTY_FUNCTION__); }));
    SwapNode(maxPrevA, maxA, &(groupA), &(swapToB));
    ((void) sizeof ((maxB != ((void*)0)) ? 1 : 0), __extension__ ({ if (maxB != ((void*)0)) ; else __assert_fail ("maxB != NULL", "/home/matt/analyze-conversion/src/Ptrdist/ks/tmp-em-orig/KS-2.c", 145, __extension__ __PRETTY_FUNCTION__); }));
    SwapNode(maxPrevB, maxB, &(groupB), &(swapToA));



    ((void) sizeof ((moduleToGroup[(*maxA).module] == GroupA) ? 1 : 0), __extension__ ({ if (moduleToGroup[(*maxA).module] == GroupA) ; else __assert_fail ("moduleToGroup[(*maxA).module] == GroupA", "/home/matt/analyze-conversion/src/Ptrdist/ks/tmp-em-orig/KS-2.c", 150, __extension__ __PRETTY_FUNCTION__); }));
    moduleToGroup[(*maxA).module] = SwappedToB;

    ((void) sizeof ((moduleToGroup[(*maxB).module] == GroupB) ? 1 : 0), __extension__ ({ if (moduleToGroup[(*maxB).module] == GroupB) ; else __assert_fail ("moduleToGroup[(*maxB).module] == GroupB", "/home/matt/analyze-conversion/src/Ptrdist/ks/tmp-em-orig/KS-2.c", 153, __extension__ __PRETTY_FUNCTION__); }));
...
SwapSubsetAndReset(unsigned long iMax)
{
  ...
  i++);
    ...
    ((void) sizeof ((mrPrevA != ((void*)0) && mrPrevB != ((void*)0)) ? 1 : 0), __extension__ ({ if (mrPrevA != ((void*)0) && mrPrevB != ((void*)0)) ; else __assert_fail ("mrPrevA != NULL && mrPrevB != NULL", "/home/matt/analyze-conversion/src/Ptrdist/ks/tmp-em-orig/KS-2.c", 202, __extension__ __PRETTY_FUNCTION__); }));
...
PrintResults(int verbose)
{
 ...
 ((void) sizeof ((moduleToGroup[(*mr).module] == GroupA) ? 1 : 0), __extension__ ({ if (moduleToGroup[(*mr).module] == GroupA) ; else __assert_fail ("moduleToGroup[(*mr).module] == GroupA", "/home/matt/analyze-conversion/src/Ptrdist/ks/tmp-em-orig/KS-2.c", 274, __extension__ __PRETTY_FUNCTION__); }));
 ...
 for (nn = modules[(*mr).module]; nn != ((void*)0); nn = (*nn).next) {
  ...
  netSz++;
     ((void) sizeof ((netSz >= 2) ? 1 : 0), __extension__ ({ if (netSz >= 2) ; else __assert_fail ("netSz >= 2", "/home/matt/analyze-conversion/src/Ptrdist/ks/tmp-em-orig/KS-2.c", 282, __extension__ __PRETTY_FUNCTION__); }));
 ...
 for (mn = nets[i]; mn != ((void*)0); mn = (*mn).next)
     netSz++;
 ((void) sizeof ((netSz >= 2) ? 1 : 0), __extension__ ({ if (netSz >= 2) ; else __assert_fail ("netSz >= 2", "/home/matt/analyze-conversion/src/Ptrdist/ks/tmp-em-orig/KS-2.c", 307, __extension__ __PRETTY_FUNCTION__); }));
...
main(int argc, _Array_ptr<_Nt_array_ptr<char>> argv : count(argc))
{
 ...
 exit(1);
    ...
    ((void) sizeof (((numModules % 2) == 0) ? 1 : 0), __extension__ ({ if ((numModules % 2) == 0) ; else __assert_fail ("(numModules % 2) == 0", "/home/matt/analyze-conversion/src/Ptrdist/ks/tmp-em-orig/KS-2.c", 355, __extension__ __PRETTY_FUNCTION__); }));
 ...
 ((void) sizeof ((groupA.head == ((void*)0) && groupA.tail == ((void*)0)) ? 1 : 0), __extension__ ({ if (groupA.head == ((void*)0) && groupA.tail == ((void*)0)) ; else __assert_fail ("groupA.head == NULL && groupA.tail == NULL", "/home/matt/analyze-conversion/src/Ptrdist/ks/tmp-em-orig/KS-2.c", 384, __extension__ __PRETTY_FUNCTION__); }));
 ((void) sizeof ((groupB.head == ((void*)0) && groupB.tail == ((void*)0)) ? 1 : 0), __extension__ ({ if (groupB.head == ((void*)0) && groupB.tail == ((void*)0)) ; else __assert_fail ("groupB.head == NULL && groupB.tail == NULL", "/home/matt/analyze-conversion/src/Ptrdist/ks/tmp-em-orig/KS-2.c", 385, __extension__ __PRETTY_FUNCTION__); }));
