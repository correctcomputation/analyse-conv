...
ReadNetList(_Nt_array_ptr<char> fname)
{
 ...
 { (head = prev = (_Ptr<Module>)malloc<Module>(sizeof(Module))); if (!(prev != ((void*)0))) { fprintf(stderr, "(%s:%s():%d): ", "/home/matt/analyze-conversion-1.wt/src/Ptrdist/ks/orig-em-tmp/KS-1.c", "ReadData", 65); fprintf(stderr, "unable to allocate a module list node", 0, 0, 0); fprintf(stderr, "\n"); exit(1); } };
 ...
 while ((tok = ((_Nt_array_ptr<char> )strtok(((void*)0), " \t\n"))) != ((void*)0)) {
     { (node = (_Ptr<Module>)malloc<Module>(sizeof(Module))); if (!(node != ((void*)0))) { fprintf(stderr, "(%s:%s():%d): ", "/home/matt/analyze-conversion-1.wt/src/Ptrdist/ks/orig-em-tmp/KS-1.c", "ReadData", 72); fprintf(stderr, "unable to allocate a module list node", 0, 0, 0); fprintf(stderr, "\n"); exit(1); } };
...
NetsToModules(void)
{
 ...
 for (modNode = nets[net]; modNode != ((void*)0); modNode = (*modNode).next) {
     { (netNode = (_Ptr<Net>)malloc<Net>(sizeof(Net))); if (!(netNode != ((void*)0))) { fprintf(stderr, "(%s:%s():%d): ", "/home/matt/analyze-conversion-1.wt/src/Ptrdist/ks/orig-em-tmp/KS-1.c", "NetsToModules", 98); fprintf(stderr, "unable to allocate net list node", 0, 0, 0); fprintf(stderr, "\n"); exit(1); } };
...
InitLists(void)
{
 ...
 { (mr = (_Ptr<ModuleRec>)malloc<ModuleRec>(sizeof(ModuleRec))); if (!(mr != ((void*)0))) { fprintf(stderr, "(%s:%s():%d): ", "/home/matt/analyze-conversion-1.wt/src/Ptrdist/ks/orig-em-tmp/KS-1.c", "main", 147); fprintf(stderr, "unable to allocate ModuleRec", 0, 0, 0); fprintf(stderr, "\n"); exit(1); } };
 ...
 { (mr = (_Ptr<ModuleRec>)malloc<ModuleRec>(sizeof(ModuleRec))); if (!(mr != ((void*)0))) { fprintf(stderr, "(%s:%s():%d): ", "/home/matt/analyze-conversion-1.wt/src/Ptrdist/ks/orig-em-tmp/KS-1.c", "main", 166); fprintf(stderr, "unable to allocate ModuleRec", 0, 0, 0); fprintf(stderr, "\n"); exit(1); } };
