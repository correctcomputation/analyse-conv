...
ReadNetList(_Nt_array_ptr<char> fname)
{
 ...
 { head = prev = calloc<Module>(1, sizeof(Module)); if (!(prev != ((void*)0))) {  { (fprintf)(stderr, "(%s:%s():%d): ", "/home/matt/analyze-conversion/src/Ptrdist/ks/tmp-em-manual/KS-1.c", "ReadData", 66); };  { (fprintf)(stderr, "unable to allocate a module list node", 0, 0, 0); };  { (fprintf)(stderr, "\n"); }; exit(1); } };
 ...
 while ((tok = ((_Nt_array_ptr<char> )strtok(((void*)0), " \t\n"))) != ((void*)0)) {
     { node = calloc<Module>(1, sizeof(Module)); if (!(node != ((void*)0))) {  { (fprintf)(stderr, "(%s:%s():%d): ", "/home/matt/analyze-conversion/src/Ptrdist/ks/tmp-em-manual/KS-1.c", "ReadData", 74); };  { (fprintf)(stderr, "unable to allocate a module list node", 0, 0, 0); };  { (fprintf)(stderr, "\n"); }; exit(1); } };
...
NetsToModules(void)
{
 ...
 for (modNode = nets[net]; modNode != ((void*)0); modNode = (*modNode).next) {
     { netNode = calloc<Net>(1, sizeof(Net)); if (!(netNode != ((void*)0))) {  { (fprintf)(stderr, "(%s:%s():%d): ", "/home/matt/analyze-conversion/src/Ptrdist/ks/tmp-em-manual/KS-1.c", "NetsToModules", 100); };  { (fprintf)(stderr, "unable to allocate net list node", 0, 0, 0); };  { (fprintf)(stderr, "\n"); }; exit(1); } };
...
InitLists(void)
{
 ...
 { mr = calloc<ModuleRec>(1, sizeof(ModuleRec)); if (!(mr != ((void*)0))) {  { (fprintf)(stderr, "(%s:%s():%d): ", "/home/matt/analyze-conversion/src/Ptrdist/ks/tmp-em-manual/KS-1.c", "main", 149); };  { (fprintf)(stderr, "unable to allocate ModuleRec", 0, 0, 0); };  { (fprintf)(stderr, "\n"); }; exit(1); } };
 ...
 { mr = calloc<ModuleRec>(1, sizeof(ModuleRec));; if (!(mr != ((void*)0))) {  { (fprintf)(stderr, "(%s:%s():%d): ", "/home/matt/analyze-conversion/src/Ptrdist/ks/tmp-em-manual/KS-1.c", "main", 168); };  { (fprintf)(stderr, "unable to allocate ModuleRec", 0, 0, 0); };  { (fprintf)(stderr, "\n"); }; exit(1); } };
