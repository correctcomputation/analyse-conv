...
void DFSClearVCG(nodeVCGType * );

void DumpVCG(nodeVCGType * );

void DFSAboveVCG(nodeVCGType * , unsigned long);

void DFSBelowVCG(nodeVCGType * , unsigned long);

void SCCofVCG(nodeVCGType * , unsigned long * , unsigned long * , unsigned long countSCC);
...
unsigned long ExistPathAboveVCG(nodeVCGType * , unsigned long above, unsigned long below);
