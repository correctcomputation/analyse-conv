...
DescribeChannel(void)
{
    ...
    TOP = malloc((channelColumns+1) * sizeof(unsigned long));




    BOT = malloc((channelColumns+1) * sizeof(unsigned long));
...
DensityChannel(void)
{
    ...
    FIRST = malloc((channelNets+1) * sizeof(unsigned long));
    LAST = malloc((channelNets+1) * sizeof(unsigned long));
    DENSITY = malloc((channelColumns+1) * sizeof(unsigned long));
    CROSSING = malloc((channelNets+1) * sizeof(unsigned long));
