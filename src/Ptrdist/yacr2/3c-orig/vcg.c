...
_Array_ptr<constraintVCGType *> removeVCG : count(removeTotalVCG) = ((void *)0);
...
AllocVCG(void)
{
    ...
    storageRootVCG = (constraintVCGType *)malloc<constraintVCGType>((channelNets + 1) * (channelNets + 1) * sizeof(constraintVCGType));
    ...
    removeVCG = (_Array_ptr<constraintVCGType *>)malloc<constraintVCGType *>((channelNets + 1) * (channelNets + 1) * sizeof(constraintVCGType *));
}
...
void DFSAboveVCG(_Array_ptr<nodeVCGType> VCG : count(net), unsigned long net)
{
    unsigned long s;
    unsigned long above;
