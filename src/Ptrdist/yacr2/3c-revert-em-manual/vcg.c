...
_Array_ptr<nodeVCGType> VCG : count(channelNets) = ((void *)0) ;
...
_Array_ptr<unsigned long> SCC : count(channelNets) = ((void *)0) ;
unsigned long totalSCC;
_Array_ptr<unsigned long> perSCC : count(channelNets) = ((void *)0) ;
