...
_Array_ptr<struct costMatrixRow> costMatrix = ((void *)0) ;
...
void
Assign(_Array_ptr<nodeVCGType> VCG : count(channelNets), _Array_ptr<unsigned long> assign, unsigned long select)
{
    long dist;
    unsigned long ideal;
    unsigned long track;
...
void
Select(_Array_ptr<nodeVCGType> VCG : count(channelNets), _Array_ptr<nodeHCGType> HCG, _Array_ptr<unsigned long> netsAssign, _Ptr<unsigned long> netSelect, _Array_ptr<unsigned long> CROSSING)
{
    unsigned long net;
    unsigned long track;
...
void
BuildCostMatrix(_Array_ptr<nodeVCGType> VCG : count(channelNets), _Array_ptr<nodeHCGType> HCG, _Array_ptr<unsigned long> netsAssign, _Array_ptr<unsigned long> CROSSING)
{
    unsigned long net;
    unsigned long track;
    unsigned long ideal;
