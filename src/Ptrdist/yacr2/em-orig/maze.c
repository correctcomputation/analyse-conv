...
DrawSegment(char * plane, unsigned long x1, unsigned long y1, unsigned long x2, unsigned long y2)
{
    ...
    ((void) sizeof (((x1 == x2) || (y1 == y2)) ? 1 : 0), __extension__ ({ if ((x1 == x2) || (y1 == y2)) ; else __assert_fail ("(x1 == x2) || (y1 == y2)", "/home/matt/analyze-conversion/src/Ptrdist/yacr2/tmp-em-orig/maze.c", 92, __extension__ __PRETTY_FUNCTION__); }));


    ((void) sizeof (((x1 != x2) || (y1 != y2)) ? 1 : 0), __extension__ ({ if ((x1 != x2) || (y1 != y2)) ; else __assert_fail ("(x1 != x2) || (y1 != y2)", "/home/matt/analyze-conversion/src/Ptrdist/yacr2/tmp-em-orig/maze.c", 95, __extension__ __PRETTY_FUNCTION__); }));
...
SegmentFree(char * plane, unsigned long x1, unsigned long y1, unsigned long x2, unsigned long y2)
{
    ...
    ((void) sizeof (((x1 == x2) || (y1 == y2)) ? 1 : 0), __extension__ ({ if ((x1 == x2) || (y1 == y2)) ; else __assert_fail ("(x1 == x2) || (y1 == y2)", "/home/matt/analyze-conversion/src/Ptrdist/yacr2/tmp-em-orig/maze.c", 165, __extension__ __PRETTY_FUNCTION__); }));
...
DrawNets(void)
{
 ...
 if ((BOT[i] == 0) && (TOP[i] == 0)) {
   ...
   i, channelTracks+1);
     ...
     ((void) sizeof (((FIRST[TOP[i]] == i) && (LAST[TOP[i]] == i)) ? 1 : 0), __extension__ ({ if ((FIRST[TOP[i]] == i) && (LAST[TOP[i]] == i)) ; else __assert_fail ("(FIRST[TOP[i]] == i) && (LAST[TOP[i]] == i)", "/home/matt/analyze-conversion/src/Ptrdist/yacr2/tmp-em-orig/maze.c", 355, __extension__ __PRETTY_FUNCTION__); }));
     DrawSegment(vertPlane,
   i, 0,
   i, channelTracks+1);
 }
   ...
   i, channelTracks+1);
     ...
     ((void) sizeof ((netsAssign[TOP[i]] > netsAssign[BOT[i]]) ? 1 : 0), __extension__ ({ if (netsAssign[TOP[i]] > netsAssign[BOT[i]]) ; else __assert_fail ("netsAssign[TOP[i]] > netsAssign[BOT[i]]", "/home/matt/analyze-conversion/src/Ptrdist/yacr2/tmp-em-orig/maze.c", 381, __extension__ __PRETTY_FUNCTION__); }));
     mazeRoute[i] = 1;
     numLeft++;
 }
#ifdef VERBOSE
...
Maze1(void)
{
 ...
 if (mazeRoute[i]) {
     ...
     s = netsAssign[TOP[i]];
     p = netsAssign[BOT[i]];
     ((void) sizeof ((s > p) ? 1 : 0), __extension__ ({ if (s > p) ; else __assert_fail ("s > p", "/home/matt/analyze-conversion/src/Ptrdist/yacr2/tmp-em-orig/maze.c", 534, __extension__ __PRETTY_FUNCTION__); }));
...
ExtendOK(unsigned long net, char * plane, unsigned long _x1, unsigned long _y1, unsigned long _x2, unsigned long _y2)
{
    ...
    ((void) sizeof (((y1 == y2) && (netsAssign[net] == y1)) ? 1 : 0), __extension__ ({ if ((y1 == y2) && (netsAssign[net] == y1)) ; else __assert_fail ("(y1 == y2) && (netsAssign[net] == y1)", "/home/matt/analyze-conversion/src/Ptrdist/yacr2/tmp-em-orig/maze.c", 654, __extension__ __PRETTY_FUNCTION__); }));
...
Maze2(void)
{
 ...
 if (mazeRoute[i]) {
     ...
     s = netsAssign[TOP[i]];
     p = netsAssign[BOT[i]];
     ((void) sizeof ((s > p) ? 1 : 0), __extension__ ({ if (s > p) ; else __assert_fail ("s > p", "/home/matt/analyze-conversion/src/Ptrdist/yacr2/tmp-em-orig/maze.c", 767, __extension__ __PRETTY_FUNCTION__); }));
...
int Maze3(void)
{
 ...
 if (mazeRoute[i]) {
     ...
     s = netsAssign[TOP[i]];
     p = netsAssign[BOT[i]];
     ((void) sizeof ((s > p) ? 1 : 0), __extension__ ({ if (s > p) ; else __assert_fail ("s > p", "/home/matt/analyze-conversion/src/Ptrdist/yacr2/tmp-em-orig/maze.c", 998, __extension__ __PRETTY_FUNCTION__); }));
