...
DrawSegment(_Array_ptr<char> plane, unsigned long x1, unsigned long y1, unsigned long x2, unsigned long y2)
{
    ...
    ((void) sizeof (((x1 == x2) || (y1 == y2)) ? 1 : 0), __extension__ ({ if ((x1 == x2) || (y1 == y2)) ; else __assert_fail ("(x1 == x2) || (y1 == y2)", "/home/matt/analyze-conversion-1.wt/src/Ptrdist/yacr2/manual-em-tmp/maze.c", 94, __extension__ __PRETTY_FUNCTION__); }));


    ((void) sizeof (((x1 != x2) || (y1 != y2)) ? 1 : 0), __extension__ ({ if ((x1 != x2) || (y1 != y2)) ; else __assert_fail ("(x1 != x2) || (y1 != y2)", "/home/matt/analyze-conversion-1.wt/src/Ptrdist/yacr2/manual-em-tmp/maze.c", 97, __extension__ __PRETTY_FUNCTION__); }));
...
SegmentFree(_Array_ptr<char> plane, unsigned long x1, unsigned long y1, unsigned long x2, unsigned long y2)
{
    ...
    ((void) sizeof (((x1 == x2) || (y1 == y2)) ? 1 : 0), __extension__ ({ if ((x1 == x2) || (y1 == y2)) ; else __assert_fail ("(x1 == x2) || (y1 == y2)", "/home/matt/analyze-conversion-1.wt/src/Ptrdist/yacr2/manual-em-tmp/maze.c", 167, __extension__ __PRETTY_FUNCTION__); }));
...
DrawNets(void)
{
 ...
 if ((BOT[i] == 0) && (TOP[i] == 0)) {
   ...
   i, channelTracks+1); }
     ...
     ((void) sizeof (((FIRST[TOP[i]] == i) && (LAST[TOP[i]] == i)) ? 1 : 0), __extension__ ({ if ((FIRST[TOP[i]] == i) && (LAST[TOP[i]] == i)) ; else __assert_fail ("(FIRST[TOP[i]] == i) && (LAST[TOP[i]] == i)", "/home/matt/analyze-conversion-1.wt/src/Ptrdist/yacr2/manual-em-tmp/maze.c", 357, __extension__ __PRETTY_FUNCTION__); }));
      { DrawSegment(_Assume_bounds_cast<_Array_ptr<char>>(vertPlane, byte_count(0)),
   i, 0,
   i, channelTracks+1); }
 }
   ...
   i, channelTracks+1); }
     ...
     ((void) sizeof ((netsAssign[TOP[i]] > netsAssign[BOT[i]]) ? 1 : 0), __extension__ ({ if (netsAssign[TOP[i]] > netsAssign[BOT[i]]) ; else __assert_fail ("netsAssign[TOP[i]] > netsAssign[BOT[i]]", "/home/matt/analyze-conversion-1.wt/src/Ptrdist/yacr2/manual-em-tmp/maze.c", 383, __extension__ __PRETTY_FUNCTION__); }));
     mazeRoute[i] = 1;
     numLeft++;
 }
#ifdef VERBOSE
...
Maze1Mech(unsigned long i,
 ...
 {
    if (SegmentFree(_Assume_bounds_cast<_Array_ptr<char>>(vertPlane, byte_count(0)),
      i, s1,
      i, s2) &&
 SegmentFree(_Assume_bounds_cast<_Array_ptr<char>>(vertPlane, byte_count(0)),
      i, b1,
      i, s2+bYdelta) &&
 SegmentFree(_Assume_bounds_cast<_Array_ptr<char>>(vertPlane, byte_count(0)),
      i, s2+bYdelta,
...
Maze1(void)
{
 ...
 if (mazeRoute[i]) {
     ...
     s = netsAssign[TOP[i]];
     p = netsAssign[BOT[i]];
     ((void) sizeof ((s > p) ? 1 : 0), __extension__ ({ if (s > p) ; else __assert_fail ("s > p", "/home/matt/analyze-conversion-1.wt/src/Ptrdist/yacr2/manual-em-tmp/maze.c", 536, __extension__ __PRETTY_FUNCTION__); }));
...
ExtendOK(unsigned long net, _Array_ptr<char> plane : count(_x1), unsigned long _x1, unsigned long _y1, unsigned long _x2, unsigned long _y2)
{
    ...
    ((void) sizeof (((y1 == y2) && (netsAssign[net] == y1)) ? 1 : 0), __extension__ ({ if ((y1 == y2) && (netsAssign[net] == y1)) ; else __assert_fail ("(y1 == y2) && (netsAssign[net] == y1)", "/home/matt/analyze-conversion-1.wt/src/Ptrdist/yacr2/manual-em-tmp/maze.c", 656, __extension__ __PRETTY_FUNCTION__); }));
          ...
          int bYdelta)
{
 ...
 for (col = xStart;
      colFree && (col != xEnd);
      col += bXdelta)  {
     if ((colFree = SegmentFree(_Assume_bounds_cast<_Array_ptr<char>>(horzPlane, byte_count(0)),
       i, row,
       col, row)) &&
  SegmentFree(_Assume_bounds_cast<_Array_ptr<char>>(vertPlane, byte_count(0)),
       i, s1,
...
Maze2(void)
{
 ...
 if (mazeRoute[i]) {
     ...
     s = netsAssign[TOP[i]];
     p = netsAssign[BOT[i]];
     ((void) sizeof ((s > p) ? 1 : 0), __extension__ ({ if (s > p) ; else __assert_fail ("s > p", "/home/matt/analyze-conversion-1.wt/src/Ptrdist/yacr2/manual-em-tmp/maze.c", 769, __extension__ __PRETTY_FUNCTION__); }));
 ...
 for (botRow = topRow+1; botRow < s2; botRow++) {
  ...
  for (botCol = botStart; botCol <= botEnd; botCol++)  {
   ...
   SegmentFree(_Assume_bounds_cast<_Array_ptr<char>>(vertPlane, byte_count(0)),
        i, s1,
        i, topRow) &&
   SegmentFree(_Assume_bounds_cast<_Array_ptr<char>>(horzPlane, byte_count(0)),
        i, topRow,
        topCol, topRow) &&
   SegmentFree(_Assume_bounds_cast<_Array_ptr<char>>(vertPlane, byte_count(0)),
        topCol, topRow,
...
int Maze3(void)
{
 ...
 if (mazeRoute[i]) {
     ...
     s = netsAssign[TOP[i]];
     p = netsAssign[BOT[i]];
     ((void) sizeof ((s > p) ? 1 : 0), __extension__ ({ if (s > p) ; else __assert_fail ("s > p", "/home/matt/analyze-conversion-1.wt/src/Ptrdist/yacr2/manual-em-tmp/maze.c", 1000, __extension__ __PRETTY_FUNCTION__); }));
