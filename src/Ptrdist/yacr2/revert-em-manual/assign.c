...
AllocAssign(void)
{
 ...
 costMatrix[net].row = malloc((channelTracks+2) * sizeof(long));
    ...
    tracksNotPref = malloc((channelTracks+2) * sizeof(unsigned long));
    tracksTopNotPref = malloc((channelTracks+2) * sizeof(unsigned long));
    tracksBotNotPref = malloc((channelTracks+2) * sizeof(unsigned long));
    tracksNoHCV = malloc((channelTracks+2) * sizeof(unsigned long));
    tracksAssign = malloc((channelTracks+2) * sizeof(unsigned long));
    netsAssign = malloc((channelNets+1) * sizeof(unsigned long));
    netsAssignCopy = malloc((channelNets+1) * sizeof(unsigned long));
}
