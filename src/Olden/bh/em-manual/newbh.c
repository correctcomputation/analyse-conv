...
int main(int argc, _Array_ptr<_Nt_array_ptr<char>> argv : count(argc)) {
  ...
  _Unchecked { (printf)("nbody = %d, numnodes = %d\n", nbody, NumNodes); };
...
treeptr old_main(void) {
  ...
  _Unchecked { (printf)("bodies created \n"); };
  ...
  for (tmp=0; tmp<NumNodes; tmp++)
    {
     _Unchecked { (printf)("Bodies per %d = %d\n",tmp ,bodiesper[tmp]); };
...
bodyptr testdata(void)
{
    ...
    if (!(0)) {_Unchecked { (printf)("Assertion Failure #%d", (99)); }; abort();};
...
void freetree(nodeptr n)
{
  ...
  for (i=(1 << 3)-1; i >= 0; i--) {
    _Unchecked { r = ((_Assume_bounds_cast<cellptr>(n))->subp)[i]; }
    if (r != ((void*)0)) {
      freetree(r);
    }
  }
...
{ register cellptr tmp = ((void*)0);
  ...
  if (cp_free_list != ((void*)0)) {
    tmp = cp_free_list;
    cp_free_list = ((cp_free_list)->next);
  }
  else
    {
...
void vp(bodyptr q, int nstep)
{
  ...
  for (; q != ((void*)0); q = ((q)->proc_next)) {
    ...
    p1=((q)->pos)[1];
    p2=((q)->pos)[2];
    if (!(!__builtin_isnan (p0))) {_Unchecked { (printf)("Assertion Failure #%d", (99)); }; abort();};
    if (!(!__builtin_isnan (p1))) {_Unchecked { (printf)("Assertion Failure #%d", (98)); }; abort();};
    if (!(!__builtin_isnan (p2))) {_Unchecked { (printf)("Assertion Failure #%d", (97)); }; abort();};
    if (!(fabs(p0)<10.0)) {_Unchecked { (printf)("Assertion Failure #%d", (96)); }; abort();};
    if (!(fabs(p1)<10.0)) {_Unchecked { (printf)("Assertion Failure #%d", (95)); }; abort();};
    if (!(fabs(p2)<10.0)) {_Unchecked { (printf)("Assertion Failure #%d", (94)); }; abort();};
#ifdef DEBUG
    ...
    p1=((q)->acc)[1];
    p2=((q)->acc)[2];
    if (!(!__builtin_isnan (p0))) {_Unchecked { (printf)("Assertion Failure #%d", (89)); }; abort();};
    if (!(!__builtin_isnan (p1))) {_Unchecked { (printf)("Assertion Failure #%d", (88)); }; abort();};
    if (!(!__builtin_isnan (p2))) {_Unchecked { (printf)("Assertion Failure #%d", (87)); }; abort();};
    if (!(fabs(p0)<10000.0)) {_Unchecked { (printf)("Assertion Failure #%d", (86)); }; abort();};
    if (!(fabs(p1)<10000.0)) {_Unchecked { (printf)("Assertion Failure #%d", (85)); }; abort();};
    if (!(fabs(p2)<10000.0)) {_Unchecked { (printf)("Assertion Failure #%d", (84)); }; abort();};
    ...
    p1=((q)->vel)[1];
    p2=((q)->vel)[2];
    if (!(!__builtin_isnan (p0))) {_Unchecked { (printf)("Assertion Failure #%d", (79)); }; abort();};
    if (!(!__builtin_isnan (p1))) {_Unchecked { (printf)("Assertion Failure #%d", (78)); }; abort();};
    if (!(!__builtin_isnan (p2))) {_Unchecked { (printf)("Assertion Failure #%d", (77)); }; abort();};
    if (!(fabs(p0)<10000.0)) {_Unchecked { (printf)("Assertion Failure #%d", (76)); }; abort();};
    if (!(fabs(p1)<10000.0)) {_Unchecked { (printf)("Assertion Failure #%d", (75)); }; abort();};
    if (!(fabs(p2)<10000.0)) {_Unchecked { (printf)("Assertion Failure #%d", (74)); }; abort();};
    ...
    p1=((q)->pos)[1];
    p2=((q)->pos)[2];
    if (!(!__builtin_isnan (p0))) {_Unchecked { (printf)("Assertion Failure #%d", (69)); }; abort();};
    if (!(!__builtin_isnan (p1))) {_Unchecked { (printf)("Assertion Failure #%d", (68)); }; abort();};
    if (!(!__builtin_isnan (p2))) {_Unchecked { (printf)("Assertion Failure #%d", (67)); }; abort();};
    if (!(fabs(p0)<10000.0)) {_Unchecked { (printf)("Assertion Failure #%d", (66)); }; abort();};
    if (!(fabs(p1)<10000.0)) {_Unchecked { (printf)("Assertion Failure #%d", (65)); }; abort();};
    if (!(fabs(p2)<10000.0)) {_Unchecked { (printf)("Assertion Failure #%d", (64)); }; abort();};
...
void expandbox(bodyptr p, treeptr t, int nsteps, int proc)
{
    ...
    while (!inbox) {
      ...
      if (!(rsize<1000.0)) {_Unchecked { (printf)("Assertion Failure #%d", (999)); }; abort();};
    ...
    if (!(ic.inb)) {_Unchecked { (printf)("Assertion Failure #%d", (1)); }; abort();};
...
nodeptr loadtree(bodyptr p, icstruct xpic, nodeptr t, int l, treeptr tr)
{
  ...
  if (t == ((void*)0))
    ...
    if (!(l != 0)) {_Unchecked { (printf)("Assertion Failure #%d", (2)); }; abort();};
    if (((t)->type) == 01) {
      int i,j;
      icstruct pic = {};
      icstruct tic = {};
    ...
    _Unchecked { rt = ((_Assume_bounds_cast<cellptr>(t))->subp)[si]; }
    _Unchecked { ((_Assume_bounds_cast<cellptr>(t))->subp)[si] = loadtree(p, xpic, rt, l >> 1, tr); }
  }
  return (t);
}
...
int subindex(bodyptr p, treeptr t , int l)
{
    ...
    xsc = (pos[0] - t->rmin[0]) / rsize;
    if (!((0.0 <= xsc) && (xsc < 1.0))) {_Unchecked { (printf)("Assertion Failure #%d", (5)); }; abort();};
    xp[0] = floor((1 << (8 * sizeof(int) - 2)) * xsc);

    xsc = (pos[1] - t->rmin[1]) / rsize;
    if (!((0.0 <= xsc) && (xsc < 1.0))) {_Unchecked { (printf)("Assertion Failure #%d", (6)); }; abort();};
    xp[1] = floor((1 << (8 * sizeof(int) - 2)) * xsc);

    xsc = (pos[2] - t->rmin[2]) / rsize;
    if (!((0.0 <= xsc) && (xsc < 1.0))) {_Unchecked { (printf)("Assertion Failure #%d", (7)); }; abort();};
...
real hackcofm(nodeptr q)
{
    ...
    if (((q)->type) == 02) {
      ...
      for (i=0; i < (1 << 3); i++) {
      _Unchecked { r = ((_Assume_bounds_cast<cellptr>(q))->subp)[i]; }
      if (r != ((void*)0)) {
        mr = hackcofm(r);
        mq = mr + mq;
...
void ptree(nodeptr n, int level)
{
  ...
  if (n != ((void*)0)) {
    if (((n)->type) == 01) {
      _Unchecked { (printf)("%2d BODY@%x %f, %f, %f\n", level, n, ((n)->pos)[0], ((n)->pos)[1], ((n)->pos)[2]); };
    }
    else {
      int i;

      _Unchecked { (printf)("%2d CELL@%x %f, %f, %f\n", level, n,((n)->pos)[0], ((n)->pos)[1], ((n)->pos)[2]); };
      for (i = 0; i < (1 << 3); i++) {
 _Unchecked { r = ((_Assume_bounds_cast<cellptr>(n))->subp)[i]; }
 ptree(r, level+1);
      }
    ...
    _Unchecked { (printf)("%2d NULL TREE\n", level); };
}
