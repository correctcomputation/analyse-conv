...
struct Village * alloc_tree(int level, int label, struct Village * back) {
  if (level == 0)
    ...
    struct Village * new = ((void*)0);
    int i;
    struct Village * fval [4] = { ((void*)0), ((void*)0), ((void*)0), ((void*)0) };
...
struct List * sim(struct Village * village)
{
  ...
  struct List * l = ((void*)0);
  struct List * up = ((void*)0);
  struct Hosp * h = ((void*)0);
  struct List * val [4] = {((void*)0), ((void*)0), ((void*)0), ((void*)0)};
