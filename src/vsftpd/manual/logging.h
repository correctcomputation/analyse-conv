 ...
 */
void vsf_log_init(_Ptr<struct vsf_session> p_sess);
 ...
 */
void vsf_log_start_entry(_Ptr<struct vsf_session> p_sess, enum EVSFLogEntryType what);
 ...
 */
int vsf_log_entry_pending(_Ptr<struct vsf_session> p_sess);

/* vsf_log_clear_entry()
 * PURPOSE
 * Clears any pending log entry.
 */
void vsf_log_clear_entry(_Ptr<struct vsf_session> p_sess);
 ...
 */
void vsf_log_do_log(_Ptr<struct vsf_session> p_sess, int succeeded);
 ...
 */
void vsf_log_line(_Ptr<struct vsf_session> p_sess, enum EVSFLogEntryType what, _Ptr<struct mystr> p_str);
