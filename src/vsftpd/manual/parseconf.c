...
static _Nt_array_ptr<const char> s_p_saved_filename : count(0) = ((void *)0);
...
static struct parseconf_bool_setting parseconf_bool_array _Checked[82] =
{
...
{
  _Nt_array_ptr<const char> p_setting_name : count(0);
  _Ptr<const char *> p_variable : itype(_Ptr<_Nt_array_ptr<const char>>);
};
#pragma CHECKED_SCOPE off
static struct parseconf_str_setting parseconf_str_array _Checked[35] =
{
...
void
vsf_parseconf_load_setting(_Nt_array_ptr<const char> p_setting, int errs_fatal)
{
  ...
  {
    _Array_ptr<const struct parseconf_str_setting> p_str_setting : count(35) = parseconf_str_array;
  ...
  {
    _Array_ptr<const struct parseconf_bool_setting> p_bool_setting : count(82) = parseconf_bool_array;
  ...
  {
    _Array_ptr<const struct parseconf_uint_setting> p_uint_setting : count(21) = parseconf_uint_array;
