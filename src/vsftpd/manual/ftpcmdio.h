 ...
 */
void vsf_cmdio_write(_Ptr<struct vsf_session> p_sess, int status, _Nt_array_ptr<const char> p_text : count(0));
 ...
 * p_text       - the text to report
 */
void vsf_cmdio_write_hyphen(_Ptr<struct vsf_session> p_sess, int status, _Nt_array_ptr<const char> p_text : count(0));
 ...
 * p_text       - the text to report
 */
void vsf_cmdio_write_raw(_Ptr<struct vsf_session> p_sess, _Nt_array_ptr<const char> p_text : count(0));
 ...
 */
void vsf_cmdio_write_exit(_Ptr<struct vsf_session> p_sess, int status, _Nt_array_ptr<const char> p_text : count(0), int exit_val);
 ...
 */
void vsf_cmdio_get_cmd_and_arg(_Ptr<struct vsf_session> p_sess, _Ptr<struct mystr> p_cmd_str, _Ptr<struct mystr> p_arg_str, int set_alarm);
