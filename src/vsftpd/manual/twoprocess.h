 ...
 */
void vsf_two_process_start(_Ptr<struct vsf_session> p_sess);
 ...
 */
void vsf_two_process_login(_Ptr<struct vsf_session> p_sess, _Ptr<const struct mystr> p_pass_str);
 ...
 */
int vsf_two_process_get_priv_data_sock(_Ptr<struct vsf_session> p_sess);
 ...
 */
int vsf_two_process_get_pasv_fd(_Ptr<struct vsf_session> p_sess);
