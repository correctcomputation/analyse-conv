...
void str_list_add(_Ptr<struct mystr_list> p_list, _Ptr<const struct mystr> p_str, _Ptr<const struct mystr> p_sort_key_str);
...
int str_list_contains_str(_Ptr<const struct mystr_list> p_list, _Ptr<const struct mystr> p_str);
