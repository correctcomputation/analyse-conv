...
static enum EVSFPrivopLoginResult handle_login(_Ptr<struct vsf_session> p_sess, _Ptr<struct mystr> p_user_str, _Ptr<const struct mystr> p_pass_str);

int
vsf_privop_get_ftp_port_sock(_Ptr<struct vsf_session> p_sess, unsigned short remote_port, int use_port_sockaddr)
{
  static _Ptr<struct vsf_sysutil_sockaddr> p_sockaddr = 0;
  _Ptr<const struct vsf_sysutil_sockaddr> p_connect_to = 0;
  int retval;
  int i;
...
vsf_privop_do_login(_Ptr<struct vsf_session> p_sess, _Ptr<const struct mystr> p_pass_str)
{
...
handle_login(_Ptr<struct vsf_session> p_sess, _Ptr<struct mystr> p_user_str, _Ptr<const struct mystr> p_pass_str)
{
...
static enum EVSFPrivopLoginResult
handle_anonymous_login(_Ptr<struct vsf_session> p_sess, _Ptr<const struct mystr> p_pass_str)
{
...
static enum EVSFPrivopLoginResult
handle_local_login(_Ptr<struct vsf_session> p_sess, _Ptr<struct mystr> p_user_str, _Ptr<const struct mystr> p_pass_str)
{
...
static void
setup_username_globals(_Ptr<struct vsf_session> p_sess, _Ptr<const struct mystr> p_str)
{
