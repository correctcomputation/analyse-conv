...
static int plain_peek_adapter(_Ptr<struct vsf_session> p_sess, _Array_ptr<char> p_buf :  count(len), unsigned int len);
static int plain_read_adapter(_Ptr<struct vsf_session> p_sess, _Array_ptr<char> p_buf : count(len), unsigned int len);
static int ssl_peek_adapter(_Ptr<struct vsf_session> p_sess, _Array_ptr<char> p_buf : count(len), unsigned int len);
...
int
ftp_read_data(_Ptr<struct vsf_session> p_sess, _Array_ptr<char> p_buf : byte_count(len), unsigned int len)
{
  if (p_sess->data_use_ssl && p_sess->ssl_slave_active)
  {
    int ret;
...
int
ftp_write_data(_Ptr<const struct vsf_session> p_sess, _Array_ptr<const char> p_buf : byte_count(len), unsigned int len)
{
  if (p_sess->data_use_ssl && p_sess->ssl_slave_active)
  {
    int ret;
...
static int
plain_peek_adapter(_Ptr<struct vsf_session> p_sess, _Array_ptr<char> p_buf : count(len), unsigned int len)
{
  (void) p_sess;
...
static int
plain_read_adapter(_Ptr<struct vsf_session> p_sess, _Array_ptr<char> p_buf : count(len), unsigned int len)
{
  (void) p_sess;
...
static int
ssl_peek_adapter(_Ptr<struct vsf_session> p_sess, _Array_ptr<char> p_buf : count(len), unsigned int len)
{
