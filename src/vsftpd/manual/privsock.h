 ...
 */
void priv_sock_init(_Ptr<struct vsf_session> p_sess);
 ...
 * p_sess       - the current session object
 */
void priv_sock_close(_Ptr<struct vsf_session> p_sess);
 ...
 * p_sess       - the current session object
 */
void priv_sock_set_parent_context(_Ptr<struct vsf_session> p_sess);
 ...
 * p_sess       - the current session object
 */
void priv_sock_set_child_context(_Ptr<struct vsf_session> p_sess);
