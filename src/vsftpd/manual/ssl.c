...
int
ssl_read(_Ptr<struct vsf_session> p_sess, _Ptr<void> p_ssl, _Array_ptr<char> p_buf : count(len), unsigned int len)
{
  (void) p_sess;
  (void) p_ssl;
  (void) p_buf;
...
int
ssl_peek(_Ptr<struct vsf_session> p_sess, _Ptr<void> p_ssl, _Array_ptr<char> p_buf : count(len), unsigned int len)
{
  (void) p_sess;
  (void) p_ssl;
  (void) p_buf;
