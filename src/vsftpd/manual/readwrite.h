...
int ftp_read_data(_Ptr<struct vsf_session> p_sess, _Array_ptr<char> p_buf : byte_count(len), unsigned int len);
int ftp_write_data(_Ptr<const struct vsf_session> p_sess, _Array_ptr<const char> p_buf : byte_count(len), unsigned int len);
