...
int ssl_read(_Ptr<struct vsf_session> p_sess, _Ptr<void> p_ssl, _Array_ptr<char> p_buf : count(len), unsigned int len);
int ssl_peek(_Ptr<struct vsf_session> p_sess, _Ptr<void> p_ssl, _Array_ptr<char> p_buf : count(len), unsigned int len);
...
int ssl_read_into_str(_Ptr<struct vsf_session> p_sess, _Ptr<void> p_ssl, _Ptr<struct mystr> p_str);
