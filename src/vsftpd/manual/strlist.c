...
{
  _Array_ptr<void> p_nodes_arr : byte_count(p_list->list_len * sizeof(struct mystr_list_node)) = 0;
  _Unchecked {
    p_nodes_arr = p_list->p_nodes;
  }
  if (!reverse)
  {
    vsf_sysutil_qsort(p_nodes_arr, p_list->list_len,
