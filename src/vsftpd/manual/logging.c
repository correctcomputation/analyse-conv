...
static void vsf_log_common(_Ptr<struct vsf_session> p_sess, int succeeded, enum EVSFLogEntryType what, _Ptr<const struct mystr> p_str);
static void vsf_log_do_log_vsftpd_format(_Ptr<struct vsf_session> p_sess, _Ptr<struct mystr> p_str, int succeeded, enum EVSFLogEntryType what, _Ptr<const struct mystr> p_log_str);
static void vsf_log_do_log_wuftpd_format(_Ptr<struct vsf_session> p_sess, _Ptr<struct mystr> p_str, int succeeded);
...
void
vsf_log_line(_Ptr<struct vsf_session> p_sess, enum EVSFLogEntryType what, _Ptr<struct mystr> p_str)
{
...
static void
vsf_log_common(_Ptr<struct vsf_session> p_sess, int succeeded, enum EVSFLogEntryType what, _Ptr<const struct mystr> p_str)
{
...
static void
vsf_log_do_log_wuftpd_format(_Ptr<struct vsf_session> p_sess, _Ptr<struct mystr> p_str, int succeeded)
{
...
static void
vsf_log_do_log_vsftpd_format(_Ptr<struct vsf_session> p_sess, _Ptr<struct mystr> p_str, int succeeded, enum EVSFLogEntryType what, _Ptr<const struct mystr> p_log_str)
{
  str_empty(p_str);
  if (!tunable_syslog_enable)
  {
