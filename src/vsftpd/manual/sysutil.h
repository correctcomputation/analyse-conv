...
void vsf_sysutil_install_sighandler(const enum EVSFSysUtilSignal sig, vsf_sighandle_t handler, _Ptr<void> p_private, int use_alarm);
...
_Itype_for_any(T) int vsf_sysutil_write(const int fd, const void* p_buf : itype(_Array_ptr<T>) byte_count(size),
...
_Itype_for_any(T) int vsf_sysutil_write_loop(const int fd, const void* p_buf : itype(_Array_ptr<T>) byte_count(size), unsigned int size);
...
void vsf_sysutil_dir_stat(_Ptr<const struct vsf_sysutil_dir> p_dir, _Ptr<_Ptr<struct vsf_sysutil_statbuf>> p_ptr);
...
filesize_t vsf_sysutil_statbuf_get_size(const struct vsf_sysutil_statbuf *p_stat : itype(_Ptr<const struct vsf_sysutil_statbuf>));
_Nt_array_ptr<const char> vsf_sysutil_statbuf_get_perms(const struct vsf_sysutil_statbuf *p_stat : itype(_Ptr<const struct vsf_sysutil_statbuf>)) : count(0);
_Nt_array_ptr<const char> vsf_sysutil_statbuf_get_date(const struct vsf_sysutil_statbuf *p_stat : itype(_Ptr<const struct vsf_sysutil_statbuf>), int use_localtime, long curr_time) : count(0);
_Nt_array_ptr<const char> vsf_sysutil_statbuf_get_numeric_date(const struct vsf_sysutil_statbuf *p_stat : itype(_Ptr<const struct vsf_sysutil_statbuf>), int use_localtime) : count(0);
unsigned int vsf_sysutil_statbuf_get_links(const struct vsf_sysutil_statbuf *p_stat : itype(_Ptr<const struct vsf_sysutil_statbuf>));
...
_Nt_array_ptr<const char> vsf_sysutil_statbuf_get_sortkey_mtime(const struct vsf_sysutil_statbuf *p_stat : itype(_Ptr<const struct vsf_sysutil_statbuf>)) : count(0);
...
int vsf_sysutil_readlink(_Nt_array_ptr<const char> p_filename, _Array_ptr<char> p_dest : count(bufsiz), unsigned int bufsiz);
...
int vsf_sysutil_wait_get_retval(_Ptr<const struct vsf_sysutil_wait_retval> p_waitret);
int vsf_sysutil_wait_exited_normally(_Ptr<const struct vsf_sysutil_wait_retval> p_waitret);
int vsf_sysutil_wait_get_exitcode(_Ptr<const struct vsf_sysutil_wait_retval> p_waitret);
...
_Itype_for_any(T) void vsf_sysutil_memcpy(void* p_dest : itype(_Array_ptr<T>) byte_count(size), const void* p_src : itype(_Array_ptr<T>) byte_count(size), const unsigned int size);
void vsf_sysutil_strcpy(_Array_ptr<char> p_dest : count(maxsize), _Array_ptr<const char> p_src : count(maxsize), unsigned int maxsize);
_Itype_for_any(T) int vsf_sysutil_memcmp(const void* p_src1 : itype(_Array_ptr<const T>) byte_count(size), const void* p_src2 : itype(_Array_ptr<const T>) byte_count(size), unsigned int size);
int vsf_sysutil_strcmp(_Nt_array_ptr<const char> p_src1, _Nt_array_ptr<const char> p_src2);
...
void vsf_sysutil_sockaddr_clone(_Ptr<_Ptr<struct vsf_sysutil_sockaddr>> p_sockptr, _Ptr<const struct vsf_sysutil_sockaddr> p_src);
int vsf_sysutil_sockaddr_addr_equal(_Ptr<const struct vsf_sysutil_sockaddr> p1, _Ptr<const struct vsf_sysutil_sockaddr> p2);
int vsf_sysutil_sockaddr_is_ipv6(_Ptr<const struct vsf_sysutil_sockaddr> p_sockaddr);

#include<netinet/in.h>

void vsf_sysutil_sockaddr_set_ipv4addr(_Ptr<struct vsf_sysutil_sockaddr> p_sockptr, _Array_ptr<const unsigned char> p_raw : byte_count(sizeof(struct in_addr)));
void vsf_sysutil_sockaddr_set_ipv6addr(_Ptr<struct vsf_sysutil_sockaddr> p_sockptr, _Array_ptr<const unsigned char> p_raw : byte_count(sizeof(struct in6_addr)));
void vsf_sysutil_sockaddr_set_ipv6scope(_Ptr<struct vsf_sysutil_sockaddr> p_sockptr, const int scope_id);
int vsf_sysutil_sockaddr_get_ipv6scope(_Ptr<struct vsf_sysutil_sockaddr> p_sockptr);
void vsf_sysutil_sockaddr_set_any(_Ptr<struct vsf_sysutil_sockaddr> p_sockaddr);
unsigned short vsf_sysutil_sockaddr_get_port(_Ptr<const struct vsf_sysutil_sockaddr> p_sockptr);
void vsf_sysutil_sockaddr_set_port(_Ptr<struct vsf_sysutil_sockaddr> p_sockptr, unsigned short the_port);
int vsf_sysutil_is_port_reserved(unsigned short port);
int vsf_sysutil_get_ipsock(_Ptr<const struct vsf_sysutil_sockaddr> p_sockaddr);
unsigned int vsf_sysutil_get_ipaddr_size(void);
_Ptr<void> vsf_sysutil_sockaddr_get_raw_addr(_Ptr<struct vsf_sysutil_sockaddr> p_sockaddr);
_Ptr<const void> vsf_sysutil_sockaddr_ipv6_v4(_Ptr<const struct vsf_sysutil_sockaddr> p_sockaddr);
_Ptr<const void> vsf_sysutil_sockaddr_ipv4_v6(_Ptr<const struct vsf_sysutil_sockaddr> p_sockaddr);
int vsf_sysutil_get_ipv4_sock(void);
int vsf_sysutil_get_ipv6_sock(void);
struct vsf_sysutil_socketpair_retval
  vsf_sysutil_unix_stream_socketpair(void);
int vsf_sysutil_bind(int fd, _Ptr<const struct vsf_sysutil_sockaddr> p_sockptr);
...
int vsf_sysutil_connect_timeout(int fd, _Ptr<const struct vsf_sysutil_sockaddr> p_sockaddr, unsigned int wait_seconds);
void vsf_sysutil_dns_resolve(_Ptr<_Ptr<struct vsf_sysutil_sockaddr>> p_sockptr, _Nt_array_ptr<const char> p_name : count(0));
...
_Nt_array_ptr<const char> vsf_sysutil_inet_ntoa(_Ptr<const void> p_raw_addr) : count(0);
int vsf_sysutil_inet_aton(_Nt_array_ptr<const char> p_text, _Ptr<struct vsf_sysutil_sockaddr> p_addr);
...
struct vsf_sysutil_user *vsf_sysutil_getpwnam(_Nt_array_ptr<const char> p_user) : itype(_Ptr<struct vsf_sysutil_user>);
const char *vsf_sysutil_user_getname(const struct vsf_sysutil_user *p_user : itype(_Ptr<const struct vsf_sysutil_user>)) : itype(_Nt_array_ptr<const char>) count(0);
const char *vsf_sysutil_user_get_homedir(const struct vsf_sysutil_user *p_user : itype(_Ptr<const struct vsf_sysutil_user>)) : itype(_Nt_array_ptr<const char>) count(0);
...
const char *vsf_sysutil_group_getname(const struct vsf_sysutil_group *p_group : itype(_Ptr<const struct vsf_sysutil_group>)) : itype(_Nt_array_ptr<const char>) count(0);
...
void vsf_sysutil_qsort(_Array_ptr<void> p_base : byte_count(num_elem * elem_size), unsigned int num_elem , unsigned int elem_size, _Ptr<int (_Ptr<const void>, _Ptr<const void>)> p_compar);
...
int vsf_sysutil_setmodtime(_Nt_array_ptr<const char> p_file, long the_time, int is_localtime);
