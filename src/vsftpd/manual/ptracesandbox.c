...
int
ptrace_sandbox_launch_process(_Ptr<struct pt_sandbox> p_sandbox, _Ptr<void (_Ptr<void>)> p_func, _Ptr<void> p_arg)
{
  (void) p_sandbox;
  (void) p_func;
  (void) p_arg;
...
void
ptrace_sandbox_permit_utimes(_Ptr<struct pt_sandbox> p_sandbox)
{
  (void) p_sandbox;
}
...
int
ptrace_sandbox_get_arg(_Ptr<struct pt_sandbox> p_sandbox, int arg, _Ptr<unsigned long> p_out)
{
  (void) p_sandbox;
  (void) arg;
  (void) p_out;
...
int
ptrace_sandbox_get_socketcall_arg(_Ptr<struct pt_sandbox> p_sandbox, int arg, _Ptr<unsigned long> p_out)
{
  (void) p_sandbox;
  (void) arg;
  (void) p_out;
...
int
ptrace_sandbox_get_long(_Ptr<struct pt_sandbox> p_sandbox, unsigned long ptr, _Ptr<unsigned long> p_out)
{
  (void) p_sandbox;
  (void) ptr;
  (void) p_out;
...
int
ptrace_sandbox_get_buf(_Ptr<struct pt_sandbox> p_sandbox, unsigned long ptr, unsigned long len, _Ptr<void> p_buf)
{
  (void) p_sandbox;
  (void) ptr;
  (void) len;
...
void
ptrace_sandbox_set_socket_validator(_Ptr<struct pt_sandbox> p_sandbox, ptrace_sandbox_validator_t val, _Ptr<void> p_arg)
{
  (void) p_sandbox;
  (void) val;
  (void) p_arg;
...
void
ptrace_sandbox_set_bind_validator(_Ptr<struct pt_sandbox> p_sandbox, ptrace_sandbox_validator_t val, _Ptr<void> p_arg)
{
  (void) p_sandbox;
  (void) val;
  (void) p_arg;
...
void
ptrace_sandbox_set_connect_validator(_Ptr<struct pt_sandbox> p_sandbox, ptrace_sandbox_validator_t val, _Ptr<void> p_arg)
{
  (void) p_sandbox;
  (void) val;
  (void) p_arg;
...
void
ptrace_sandbox_set_setsockopt_validator(_Ptr<struct pt_sandbox> p_sandbox, ptrace_sandbox_validator_t val, _Ptr<void> p_arg)
{
  (void) p_sandbox;
  (void) val;
  (void) p_arg;
...
void
ptrace_sandbox_set_getsockopt_validator(_Ptr<struct pt_sandbox> p_sandbox, ptrace_sandbox_validator_t val, _Ptr<void> p_arg)
{
  (void) p_sandbox;
  (void) val;
  (void) p_arg;
