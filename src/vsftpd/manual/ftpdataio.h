...
struct vsf_transfer_ret vsf_ftpdataio_transfer_file(_Ptr<struct vsf_session> p_sess, int remote_fd, int file_fd, int is_recv, int is_ascii);
 ...
 */
int vsf_ftpdataio_transfer_dir(_Ptr<struct vsf_session> p_sess, int is_control, _Ptr<struct vsf_sysutil_dir> p_dir, _Ptr<const struct mystr> p_base_dir_str, _Ptr<const struct mystr> p_option_str, _Ptr<const struct mystr> p_filter_str, int is_verbose);
